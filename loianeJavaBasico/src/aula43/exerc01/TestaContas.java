...
public class TestaContas {
	...
	public static void main(String[] args) {
		...
		ContaPoupança contaPopanca = new ContaPoupança();
		contaPopanca.setNomeCliente("Cliente conta Popanca");
		contaPopanca.setNumConta("2222");
		contaPopanca.setDiaRendimento(20);
